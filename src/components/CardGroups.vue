<template>
    <div class="container" style="margin-top: 3vh">
        <div>
            <button type="button" class="w-100 btn orange round" @click="openCardGroupAddModal()">
        ...
        <div class="modal-content">
            <div class="container">
                <div class="d-flex justify-content: center mb-1">
                    <div class="w-100 orange text-dark round">Are you sure to delete {{ deleteCardGroupName }}</div>
                </div>
                <div class="deleteModal">
                    ...
                    <button type="button" class="btn btn-danger round" style="grid-area: no" @click="closeCardGroupDeleteModal()">
