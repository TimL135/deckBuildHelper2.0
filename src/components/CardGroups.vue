        ...
        <div class="modal-content">
            <div class="container">
                <div class="d-flex justify-content: center mb-1">
                    <div class="w-100 orange text-dark">Are you sure to delete {{ deleteCardGroupName }}</div>
                </div>
                <div class="deleteModal">
                    ...
                    <button type="button" class="btn btn-danger" style="grid-area: no" @click="closeCardGroupDeleteModal()">
