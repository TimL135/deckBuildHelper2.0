<template>
    ...
    <div class="container mt-2">
        ...
        <div class="cardTable p-2" v-for="card in deck.sideCards" :key="card.name" :class="card.type" style="border-bottom: 1px solid black">
        ...
        <div class="modal-content">
            <div class="container">
                <form @submit.prevent="editAddCard()">
                    ...
                    <br />
                    <button type="submit" class="btn w-100 mt-1 orange">&#10004;</button>
                </form>
            </div>
        </div>
    </div>
