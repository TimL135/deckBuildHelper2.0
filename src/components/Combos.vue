<template>
    <div class="container" style="margin-top: 3vh">
        <div>
            <button type="button" class="w-100 btn orange" @click="openComboAddModal()">Add new Combo</button>
        </div>
        <br />
    ...
    <div id="comboDeleteModal" class="modal">
        <div class="modal-content">
            ...
            <div class="container">
                ...
                <div class="d-flex justify-content: center">
                    <button type="button" class="btn btn-success w-50" @click="deleteCombo(deleteCardId)">Yes</button>
                    <button type="button" class="btn btn-danger w-50" @click="closeComboDeleteModal()">No</button>
                </div>
            </div>
        </div>
    </div>
