        ...
        <div class="modal-content">
            <div class="container">
                <div class="d-flex justify-content: center mb-1">
                    <div class="w-100 orange text-dark round">Are you sure to delete combo{{ deleteComboIndex + 1 }}</div>
                </div>
                <div class="deleteModal">
                    <button type="button" class="btn btn-success round me-1" style="grid-area: yes" @click="deleteCombo()">
                    ...
                    <button type="button" class="btn btn-danger round" style="grid-area: no" @click="closeComboDeleteModal()">
